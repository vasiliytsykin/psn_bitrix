...
<div class="wrapper-outer">
 ...
 <a href="http://www.psngroup.ru" target="_blank" class="footer__copyright">© Девелопер проекта: ГРУППА ПСН 2017 <span class="dev-logo"></span></a> <a href="#" class="footer__pdf">Проектная декларация ООО&nbsp;«Феодосийская»&nbsp;[&nbsp;PDF.&nbsp;3&nbsp;мб&nbsp;]</a> <a href="#policy-popup" class="footer__policy">Политика конфиденциальности</a>
...
<div class="feedback-modal mfp-hide" id="feedback-modal">
 ...
 <input type="text" name="phone" placeholder="Телефон">
			...
			<div class="input-group call-time">
				<div class="calendar">
 <input type="hidden" name="date" class="feedback-call__date" id="feedback-call__date"> <label for="feedback-call__date" id="feedback-call__label">Сегодня</label>
				</div>
				<div class="time">
 ...
 <a href="#" class="btn-default btn-medium btn-green">Отправить</a>
	</div>
	<div class="switch">
