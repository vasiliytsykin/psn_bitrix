...
$this->fontdata = array(
	...
	"geometria" => array(
		...
		'R' => "geometria-webfont.ttf",
		'B' => "geometria-medium-webfont.ttf",

	),

	"bw_surco" => array(

		'R' => "bwsurcodemo-regular-webfont.ttf",
		'B' => "bwsurcodemo-medium-webfont.ttf",

	),
	"als_rublregular" => array(

		'R' => "rouble-webfont.ttf"
